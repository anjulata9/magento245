<?php
namespace Anjulata\DynamicRow\Block\Adminhtml\Form\Field;

use Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray;
use Magento\Framework\DataObject;
use Magento\Framework\Exception\LocalizedException;
use Anjulata\DynamicRow\Block\Adminhtml\Form\Field\TaxColumn;
...
class Ranges extends AbstractFieldArray
{
	...
	{
		$this->addColumn('form_qty', ['label' => __('Form'), 'class' => 'required-entry']);
